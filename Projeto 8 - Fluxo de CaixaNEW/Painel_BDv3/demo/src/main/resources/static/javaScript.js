...
async function findTotalColeta() {
  try {
    const response = await fetch('http://172.16.0.197:7872/totalColeta');
    const data = await response.json();
...
async function findTotalCriticadas() {
  try {
    const response = await fetch('http://172.16.0.197:7872/totalCriticadas');
    const data = await response.json();
...
async function findTotalPendentes() {
  try {
    const response = await fetch('http://172.16.0.197:7872/totalPendentes');
    const data = await response.json();
...
async function findTotalAtualizadas() {
  try {
    const response = await fetch('http://172.16.0.197:7872/totalAtualizadas');
    const data = await response.json();
 ...
 async function findTotalLojas() {
  try {
    ...
    async function  atualizarTotais() {
        ...
        'http://172.16.0.197:7872/tabela_coleta',//
        tableColeta,
        'DATA',
        '#dateColeta'
        );
        ...
        'http://172.16.0.197:7872/tabela_pendentes',//
        tablePendentes,
        'DATA',
        '#datePendente'
        );
        await findTableLojas(
        'http://172.16.0.197:7872/tabela_criticadas',//
        tableCriticadas,
        'DATA',
        '#dateCriticada'
        );
        await findTableLojas(
        'http://172.16.0.197:7872/tabela_atualizadas',//
        tableAtualizadas,
        'DATA',
        '#dateAtualizada'
        );
