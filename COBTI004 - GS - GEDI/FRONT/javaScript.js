...
async function totaisAdjust(NAFILA) {
    let data = await fetch(`http://192.168.0.51:9473/totaisAdjust`);
    ...
    try {
        ...
        data.forEach(func => {
            ...
            linhas +=
                ...
                <td class="gsMsg">${func.CTRL_RMS_MENSAGEM}</td>
...
async function getTotais() {
    ...
    await tables(`http://192.168.0.51:9473/tableNAFILA`, tableSelectorNAFILA);
}
